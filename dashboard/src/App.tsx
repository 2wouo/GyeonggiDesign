...
import { Home as HomeIcon, Calendar as CalendarIcon, MessageSquare, ShieldAlert, Bell, ClipboardList, Mail, Book } from 'lucide-react';
import './App.css';
...
const AppLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navItems = [
    ...
    { path: '/archive', label: '지난 년도 작업물', icon: <Book size={20} /> },
